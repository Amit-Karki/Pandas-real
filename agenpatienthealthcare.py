...
''' By using this insights hospital management team can
    figure out which age group is our number one patient
    and make decisions like increasing or decreasing serivices
    based on that'''